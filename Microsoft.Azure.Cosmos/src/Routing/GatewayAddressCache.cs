...
namespace Microsoft.Azure.Cosmos.Routing
{
    ...
    internal class GatewayAddressCache : IAddressCache, IDisposable
    {
            ...
            bool useMasterCollectionResolver)
        {
            ...
            FeedResource<Address> addressFeedResponse = await this.gatewayStoreClient.GetAccountResourceAsync<FeedResource<Address>>(targetEndpoint, headers);
            ...
            bool forceRefresh)
        {
            ...
            string identifier = GatewayAddressCache.LogAddressResolutionStart(request, targetEndpoint);
            FeedResource<Address> addressFeed = await this.gatewayStoreClient.GetAccountResourceAsync<FeedResource<Address>>(targetEndpoint, headers);
            GatewayAddressCache.LogAddressResolutionEnd(request, identifier);
