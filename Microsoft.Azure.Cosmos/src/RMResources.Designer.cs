...
namespace Microsoft.Azure.Documents {
    ...
    internal class RMResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The given request [{0} {1}] with ResourceType [{2}] cannot be authorized by AAD token in data plane..
        /// </summary>
        internal static string AadAuthActionNotSupported {
            get {
                return ResourceManager.GetString("AadAuthActionNotSupported", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Could not parse action from [{0}] request on [{1}]..
        /// </summary>
        internal static string AadAuthCouldNotParseAction {
            get {
                return ResourceManager.GetString("AadAuthCouldNotParseAction", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The request path {0} is invalid..
        /// </summary>
        internal static string InvalidRequestUrl {
            get {
                return ResourceManager.GetString("InvalidRequestUrl", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Database account was created successfully, but the following regions failed to be added to account: &lt; br/ &gt;.
        /// </summary>
        internal static string PrimarySuceededButAdditionalRegionsFailed {
            get {
                return ResourceManager.GetString("PrimarySuceededButAdditionalRegionsFailed", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Database account creation failed. Operation Id: {0}, Error : {1}.
        /// </summary>
        internal static string PrimaryWriteRegionFailedFormat {
            get {
                return ResourceManager.GetString("PrimaryWriteRegionFailedFormat", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0} : Operation Id : {1}, Error : {2} &lt; br/ &gt;.
        /// </summary>
        internal static string SecondaryRegionsFailedFormat {
            get {
                return ResourceManager.GetString("SecondaryRegionsFailedFormat", resourceCulture);
            }
        }
