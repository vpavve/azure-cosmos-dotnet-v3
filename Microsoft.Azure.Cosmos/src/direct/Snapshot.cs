    ...
    class Snapshot : Resource
    {
        ...
        internal SnapshotContent Content
        {
            get
            {
                ...
                {
                    this.snapshotContent = base.GetValue<SnapshotContent>(Constants.Properties.Content);
                }
            ...
            set
            {
                ...
                base.SetValue(Constants.Properties.Content, value);
            }
        }
        ...
        internal override void OnSave()
        {
            ...
            if (this.snapshotContent != null)
            {
                base.SetValue(Constants.Properties.Content, this.snapshotContent);
            }
        }
