...
namespace Microsoft.Azure.Documents
{
    ...
    internal sealed class StoreReader
    {
            ...
            ConnectionStateListener connectionStateListener)
        {
            ...
            this.canUseLocalLSNBasedHeaders = VersionUtility.IsLaterThan(HttpConstants.Versions.CurrentVersion, HttpConstants.VersionDates.v2018_06_18);
        }
            ...
            bool forceReadAll = false)
        {
            ...
            Tuple<IReadOnlyList<Uri>, AddressCacheToken> addressInfo = await this.addressSelector.ResolveAllUriAsync(
                    entity,
                    includePrimary,
                    entity.RequestContext.ForceRefreshAddressCache);
                    
            List<Uri> resolveApiResults = addressInfo.Item1.ToList();
            ...
            bool useSessionToken)
        {
            ...
            Tuple<Uri, AddressCacheToken> addressInfo = await this.addressSelector.ResolvePrimaryUriAsync(
                entity,
                entity.RequestContext.ForceRefreshAddressCache);
